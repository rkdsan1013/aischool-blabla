...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-rose-500 flex items-center justify-center p-4 relative overflow-hidden">
      {/* --- [배경 데코레이션] AuthPage 데스크탑 패널 스타일과 통일 --- */}
      ...
      <div className="relative z-10 text-center">
        {/* 로고: AuthPage와 폰트 굵기(extrabold) 및 자간(tracking-tight) 통일 */}
        <h1
          className={`text-6xl sm:text-7xl md:text-8xl font-extrabold text-white mb-4 tracking-tight 
        ...
        {/* 소개 멘트: text-rose-100으로 색상 톤 통일 */}
        <p
          className={`text-lg sm:text-xl md:text-2xl text-rose-100 font-medium mb-12 
        ...
        >
          {/* 시작하기 버튼 - AuthPage 버튼 스타일(rounded-2xl, scale-0.98) 참조 */}
          <button
            ...
            className="w-full sm:w-auto min-w-[200px] h-14 sm:h-16 
                       ...
                       hover:bg-rose-50 hover:scale-105 hover:shadow-rose-900/20 active:scale-[0.98]"
          >
            시작하기
          </button>

          {/* 로그인 버튼 - 글래스모피즘 스타일 유지하되 모서리와 클릭 효과 통일 */}
          <button
            ...
            className="w-full sm:w-auto min-w-[200px] h-14 sm:h-16 
                       ...
                       hover:bg-white/20 hover:scale-105 active:scale-[0.98]"
          >
            로그인
          </button>
        </div>
